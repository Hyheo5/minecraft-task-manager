      ...
      <EdgeLabelRenderer>
        ...
        >
          <button
            ...
            className="w-5 h-5 bg-neutral-800 hover:bg-red-500/90 text-neutral-400 hover:text-white rounded-full flex items-center justify-center border border-neutral-600 transition-colors cursor-pointer"
            title="Delete Edge"
          >
            <X className="w-3 h-3" />
          </button>
